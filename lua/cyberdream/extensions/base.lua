...
function M.get(opts, t)
    ...
    local highlights = {
        ...
        Substitute = { fg = t.red, bg = t.bgHighlight, bold = true },
        LineNr = { fg = t.grey, bold = true },
        CursorLineNr = { fg = t.lblue },
        -- MatchParen = { fg = t.pink, bg = t.bgHighlight },
        MatchParen = { fg = t.bg, bg = t.pink, bold = true },
        ModeMsg = { fg = t.fg },
        MsgArea = { fg = t.fg },
        MoreMsg = { fg = t.blue },
        ...
        Title = { fg = t.lblue, bold = true },
        Visual = { fg = t.cyan, bg = t.bgHighlight },
        VisualNOS = { bg = t.bgHighlight },
        WarningMsg = { fg = t.orange },
        Whitespace = { fg = t.bgHighlight },
        WildMenu = { fg = t.bg, bg = t.blue, bold = true },
